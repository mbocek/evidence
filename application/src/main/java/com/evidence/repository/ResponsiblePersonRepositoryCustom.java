...
/**
 * Custom extension for responsible person repository.
 * @author Michal Bocek
 * @since 1.0.0
 */
public interface ResponsiblePersonRepositoryCustom {
	 ...
	 * @param Long kindergarteId
	 * @return
	 */
	List<ResponsiblePerson> findByKindergartenId(Long kindergarteId);
