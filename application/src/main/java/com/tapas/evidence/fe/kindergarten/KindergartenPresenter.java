 ...
 * under the License.
 */
package com.tapas.evidence.fe.kindergarten;
...
import com.tapas.evidence.service.FormMetaModelService;
...
public class KindergartenPresenter extends FactoryPresenter<IKindergartenListView, KindergartenEventBus> {
	...
	public void onRemoveKindergarten() {
		...
		if (selected != null) {
			...
			this.kindergartenService.delete(((KindergartenDTO)selected).getId());
		}
	}
