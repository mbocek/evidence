...
public class ChildRepositoryImpl implements ChildRepositoryCustom {
	...
	/* (non-Javadoc)
	 * @see com.tapas.evidence.repository.ChildRepositoryCustom#findAll()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.tapas.evidence.repository.ChildRepositoryCustom#findByKindergartenId(java.lang.Long)
	 */
	@Override
	@SuppressWarnings("unchecked")
