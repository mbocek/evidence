...
public class ResponsiblePersonRepositoryImpl implements ResponsiblePersonRepositoryCustom {
	...
	/* (non-Javadoc)
	 * @see com.tapas.evidence.repository.ResponsiblePersonRepositoryCustom#findAll(boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.tapas.evidence.repository.ResponsiblePersonRepositoryCustom#findByKindergartenId(java.lang.Long)
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/* (non-Javadoc)
	 * @see com.tapas.evidence.repository.ResponsiblePersonRepositoryCustom#findByKindergartenIdAndType(java.lang.Long, com.tapas.evidence.entity.ResponsibilityType)
	 */
	@Override
	@SuppressWarnings("unchecked")
